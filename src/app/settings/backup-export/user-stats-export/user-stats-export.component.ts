...
@Component({
  selector: 'app-user-stats-export',
  templateUrl: './user-stats-export.component.html',
  styleUrls: ['./user-stats-export.component.scss']
})
export class UserStatsExportComponent implements OnInit {
  ...
  export_stat = function () {
    // if (this.export_settings.single.stat_export_email == ""){
