...
@Component({
  selector: 'app-activity-log-product',
  templateUrl: './activity-log-product.component.html',
  styleUrls: ['./activity-log-product.component.scss']
})
export class ActivityLogProductComponent implements OnInit {
  ...
  async get_products_list(page) {
    ...
    this.product_single_details(this.products,true);
  }
  ...
  product_single_details(products,auto){
  ...
  update_single_product(){
    ...
    this.product_single_details(this.basicInfoId,true);
  },error => {
