...
@Component({
  selector: 'app-inventory-kit-product',
  templateUrl: './inventory-kit-product.component.html',
  styleUrls: ['./inventory-kit-product.component.scss']
})
export class InventoryKitProductComponent implements OnInit {
