...
@Component({
  selector: 'app-inactive-kits',
  templateUrl: './inactive-kits.component.html',
  styleUrls: ['./inactive-kits.component.scss']
})
export class InactiveKitsComponent implements OnInit {
